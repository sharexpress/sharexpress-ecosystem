      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="premium-card p-7 border border-white/[0.05] bg-white/[0.015] flex items-start gap-5 group hover:border-cyan-500/10 transition-all">
          ...
          <div>
            ...
            <a href="https://services.sharexpress.in" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-[11px] text-cyan-400 hover:text-cyan-300 font-semibold transition-colors">
