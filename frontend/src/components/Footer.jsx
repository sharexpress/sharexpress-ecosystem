          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="https://services.sharexpress.in" className="text-[13px] font-normal text-white/35 hover:text-white/80 transition-colors duration-400 link-underline inline-flex items-center gap-1.5 group">
